...
import { Box, Button, ButtonGroup, IconButton, Modal, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, Grid, useMediaQuery, useTheme } from '@mui/material'
        ...
        <Box p={isMobile ? 2 : 4}>
            ...
            <Modal open={deleteModalOpen} onClose={handleCloseDeleteModal}>
                <Box sx={modalBoxStyle}>
                    ...
                    <Button variant="contained" color="error" fullWidth onClick={() => selectedProgram && handleDelete(selectedProgram.id)}>
                        Hapus
                    </Button>
                </Box>
            </Modal>
