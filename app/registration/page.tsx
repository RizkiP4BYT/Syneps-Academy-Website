        ...
        <LocalizationProvider dateAdapter={AdapterDateFns}>
            <Container maxWidth="md" sx={{ mt: 5 }}>
                ...
                <Typography variant="body1" align="center" paragraph>
                    Khusus Program Bootcamp, setelah kirim formulir kamu akan pindah ke halaman registration fee Rp100rb untuk amankan kursimu sebelum kuota penuh!
                </Typography>
                ...
                <Card sx={{ p: 4 }}>
                    ...
                    <FormControl component="fieldset" sx={{ mb: 3 }}>
                        <RadioGroup row value={program} onChange={(e) => setProgram(e.target.value)}>
                            <FormControlLabel
                                value="bootcamp"
                                control={<Radio />}
                                label={
                                    <>
                                        ...
                                        <Typography variant="body2">Program pembelajaran full-time yang di bidang IT dengan jadwal belajar intensif.</Typography>
                                    </>
                                }
                            />
                            <FormControlLabel
                                ...
                                label={
                                    <>
                                        ...
                                        <Typography variant="body2">Program pembelajaran di luar jam kerja untuk upskilling di bidang IT.</Typography>
                                    </>
                                }
                            />
                        </RadioGroup>
                    ...
                    <form onSubmit={handleSubmit}>
                        <FormControl fullWidth sx={{ mb: 3 }}>
                            ...
                            <Select name="selectedProgram" value={selectedProgram} onChange={(e) => setSelectedProgram(e.target.value)}>
                        ...
                        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
                            <CustomTextField fullWidth label="Nama Depan Sesuai KTP" name="firstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                            <CustomTextField fullWidth label="Nama Belakang Sesuai KTP" name="lastName" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                        </div>

                        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
                            <CustomTextField fullWidth label="Email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} />
                        ...
                        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
                            <CustomTextField fullWidth label="No Hp" name="phone" value={phone} onChange={(e) => setPhone(e.target.value)} />
                            <CustomTextField fullWidth label="Nomor HP Kerabat Tidak Serumah" name="emergencyPhone" value={emergencyPhone} onChange={(e) => setEmergencyPhone(e.target.value)} />
                        </div>
                        ...
                        <FormControl fullWidth sx={{ mb: 3 }}>
                            ...
                            <TextField multiline rows={3} name="address" value={address} onChange={(e) => setAddress(e.target.value)} fullWidth />
                        </FormControl>
                        ...
                        <FormControl fullWidth sx={{ mb: 3 }}>
                            ...
                            <Select name="motivation" value={motivation} onChange={(e) => setMotivation(e.target.value)}>
                                <MenuItem value="">Select...</MenuItem>
                                {/* Add more MenuItem components as needed */}
                            </Select>
                        </FormControl>
                        ...
                        <CustomTextField fullWidth label="Kode Referal" name="referralCode" value={referralCode} onChange={(e) => setReferralCode(e.target.value)} sx={{ mb: 3 }} />

                        <FormControlLabel
                            control={<Checkbox name="agreeTerms" checked={agreeTerms} onChange={(e) => setAgreeTerms(e.target.checked)} />}
